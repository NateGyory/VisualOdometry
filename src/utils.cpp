...
{
    std::string imuDataFile = "/home/nate/Development/StereoSLAM/datasets/EuRoC/mav0/leica0/data.csv";
    rapidcsv::Document doc(imuDataFile);
    ...
    std::vector<unsigned long> col = doc.GetColumn<unsigned long>("#timestamp [ns]");
    ...
    imuPath.header = pathHeader;
    imuPath.poses = poseArr;
}
