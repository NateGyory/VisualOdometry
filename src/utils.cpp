...
void ParseImuPath(nav_msgs::Path &imuPath) {
  std::string imuDataFile =
      "/home/nate/Development/StereoSLAM/datasets/EuRoC/mav0/leica0/data.csv";
  ...
  std::vector<unsigned long> col =
      doc.GetColumn<unsigned long>("#timestamp [ns]");
...
void ParseGroundTruth(nav_msgs::Path &groundTruth) {
  std::string groundTruthFile =
      "/home/nate/Development/StereoSLAM/datasets/EuRoC/mav0/"
